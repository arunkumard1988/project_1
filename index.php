                            ...
                            <ul>
                                <li>
                                    <div class="job-details">
                                        <p class="customer-name">Adam Clark</p>
                                        <p class="bill-no">SO-00020 <span> | </span> <span class="bill-date">18/10/2015</span></p>
                                    </div>
                                    <div class="job-status">
                                         <p class="job-amount">Rs 45,000</p>
                                         <p class="job-badge">Pending</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="job-details">
